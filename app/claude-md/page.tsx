...
export default function ClaudeMdPage() {
  ...
  if (loading) {
    return <div className="p-8 font-mono text-sm text-paper/40">กำลังโหลด...</div>;
  }

  return (
    <div className="flex flex-col h-screen">
      <header className="px-8 py-5 border-b border-line">
        <p className="font-mono text-[11px] text-paper/40">~/.claude/CLAUDE.md</p>
        <h1 className="text-xl font-mono">claude.md</h1>
      </header>
      <textarea
        value={content}
        onChange={(e) => {
